  ...
  return (
    <section className={styles.info}>
      <div className={styles.info_name}>
        <h1 className="text-3xl space-x-1.5 font-bold">
          {editingField === "name" ? (
            <>
              <TextInput
                width={'auto'}
              ...
              >
                {isUpdated ? <CastpointLoader /> : <Check color="black" />}
              </button>
              <button
                className="cursor-pointer"
            ...
            <>
              <span className="mr-">{user.name}</span>
              <button
                className="cursor-pointer"
        ...
        {/* Country */}
        <p className={styles.info_who}>{user.role} from {user.country}</p>

        {/* Date of birth */}
        <p className={styles.info_date}>Born: {formattedDate}</p>
      </div>
      ...
      <div className={styles.info_password}>
        <div className="md:col-span-2">
          ...
          {editingField === "password" ? (
            ...
            <p className="whitespace-pre-line  flex mt-2 text-black">
      ...
      {/* Sex */}
      <div className={styles.info_gender}>
      ...
      <div className={styles.info_height}>
        ...
        {editingField === "height_weight" ? (
          ...
          <p className="text-black">{user.height} cm / {user.weight} kg</p>
        )}
      </div>
      ...
      <div className={styles.info_picture}>
        {editingField === "profile_picture" ? (
          ...
          <div className="relative">
            ...
            />
            <button
              className="flex items-center absolute bg-white rounded-3xl py-2 px-2 top-5 left-5 cursor-pointer"
        ...
        {(user.instagram || user.facebook) && (
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              {user.instagram && (
                <a href={`https://www.instagram.com/${trimFunction(user.instagram)}`} target="_blank" rel="noopener noreferrer" className="text-black hover:underline flex space-x-1 items-end">
                  <Instagram />
                  <p>Instagram</p>
                </a>
              )}
              {user.facebook && (
                <a href={user.facebook} target="_blank" rel="noopener noreferrer" className="text-black hover:underline">
                  Facebook
                </a>
              )}
            </div>
        ...
        <div className="flex flex-col space-y-2 text-sm w-full break-words">
          <div className="md:col-span-2 mb-5">
            ...
            {editingField === "biography" ? (
              ...
              <p className="whitespace-pre-line mt-2 text-xl text-black">
                {user.biography}
              </p>
            )}
          </div>
